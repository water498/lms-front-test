        ...
        <div className="bg-zinc-800 rounded-2xl border border-zinc-700 p-8">
          {sent ? (
            <div className="text-center">
              ...
              <Link href="/backoffice/login" className="text-sm text-violet-400 hover:text-violet-300">
                로그인으로 돌아가기
              </Link>
            </div>
          ) : (
            <>
              ...
              <div className="mt-6 text-center">
                <Link href="/backoffice/login" className="inline-flex items-center gap-1.5 text-sm text-zinc-400 hover:text-zinc-200 transition-colors">
