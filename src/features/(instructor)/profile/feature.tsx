  ...
  return (
    <div className="p-8 flex flex-col gap-6 max-w-2xl">
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">수강생에게 표시되는 강사 프로필을 편집합니다.</p>
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between py-2">
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-0.5">비공개 시 강사 목록에 표시되지 않습니다.</p>
          </div>
          <button
            onClick={() => handleChange("isPublic", !form.isPublic)}
            className={`relative w-10 h-5.5 rounded-full transition-colors ${
              form.isPublic ? "bg-violet-600" : "bg-zinc-700"
            }`}
          >
            <span
