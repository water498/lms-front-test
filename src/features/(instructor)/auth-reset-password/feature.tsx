        ...
        <div className="bg-zinc-800 rounded-2xl border border-zinc-700 p-8">
          {done ? (
            <div className="text-center">
              ...
              <Link href="/backoffice/login" className="inline-block w-full py-2.5 bg-violet-600 text-white rounded-lg text-sm font-semibold hover:bg-violet-500 transition-colors text-center">
                로그인하러 가기
              </Link>
            </div>
          ) : (
