...
export default function StudentResetPasswordFeature() {
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
          {done ? (
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-slate-900 mb-2">비밀번호가 재설정되었습니다</h2>
              <p className="text-sm text-slate-500 mb-7">새 비밀번호로 로그인하세요.</p>
              <Link
                href="/student/login"
            ...
            <>
              <div className="text-center mb-7">
                ...
                <p className="text-sm text-slate-500 mt-1.5">사용할 새 비밀번호를 입력하세요.</p>
              </div>
