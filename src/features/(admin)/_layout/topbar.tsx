...
const PAGE_TITLE_MAP: { prefix: string; label: string }[] = [
  { prefix: "/experiments/admin/courses/categories",      label: "카테고리 관리" },
  { prefix: "/experiments/admin/courses/",                label: "과정 상세" },
  { prefix: "/experiments/admin/courses",                 label: "과정 관리" },
  { prefix: "/experiments/admin/sessions",                label: "차수 목록" },
  ...
  { prefix: "/experiments/admin/assessments/exams",       label: "시험" },
  { prefix: "/experiments/admin/assessments/assignments", label: "과제" },
  { prefix: "/experiments/admin/assessments/surveys",     label: "설문" },
  { prefix: "/experiments/admin/assessments",             label: "평가 관리" },
  { prefix: "/experiments/admin/certificates/templates",  label: "수료증 템플릿" },
  { prefix: "/experiments/admin/certificates/issued",     label: "발급 내역" },
