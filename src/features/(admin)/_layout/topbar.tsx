...
const PAGE_TITLE_MAP: {
  ...
  {
    prefix: "/backoffice/courses/categories",
    label: "카테고리 관리",
    description:
      "과정을 분류하는 대·중·소 3단계 태그 체계. 학습자 탐색 시 필터로 쓰이며, 과정당 카테고리는 하나입니다.",
  },
  {
    prefix: "/backoffice/courses/",
    label: "과정 상세",
