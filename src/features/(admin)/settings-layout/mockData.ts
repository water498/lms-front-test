export const orgSettings = {
  name: "Lotte",
  portalName: "Lotte LMS",
  contactEmail: "safety@lotte.com",
  brandColor: "#7C3AED",
  subdomain: "lotte",
