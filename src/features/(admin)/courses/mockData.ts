...
export const courses: Course[] = [
  { id: "c1", title: "React 기초",            instructor: "이준혁", status: "PUBLISHED", mode: "ONLINE",  sessions: 4, enrollees: 312, createdAt: "2024-12-01", category: "프론트엔드", tags: ["React", "JavaScript", "초급"],        certConfig: { templateId: "t1", completionRate: 80,  requireExam: false, autoIssue: true  }, description: "React의 핵심 개념부터 컴포넌트 설계까지 배우는 입문 과정입니다. JSX, 상태 관리, 이벤트 처리를 실습 중심으로 학습합니다.", price: 89000,  defaultMinEnrollment: 10, cancellationPolicy: DEFAULT_CANCELLATION_POLICY },
