...
export const initialIssuedCerts: IssuedCert[] = [
  ...
  },
  {
    ...
    recipient: "이서연",  course: "React 기초",        templateId: "t1",
    status: "VALID",
  ...
  },
  {
    ...
    recipient: "김민준",  course: "AWS 클라우드 입문", templateId: "t2",
    status: "VALID",
  ...
  },
  {
    ...
    recipient: "최유진",  course: "React 기초",        templateId: "t1",
    status: "REVOKED",
  ...
  },
  {
    ...
    recipient: "정하은",  course: "TypeScript 심화",   templateId: "t1",
    status: "VALID",
  ...
  },
  {
    ...
    recipient: "홍길동",  course: "기본 수강 확인증",  templateId: "t3",
    status: "EXPIRED",
