...
import { type CourseSession, type OfflineSession, type OfflineSessionStatus, type CourseInstructor, getOfflineSessions, getOfflineAttendances } from "../course-layout/mockData";
                  ...
                  return (
                    <tr key={os.id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-slate-600">
                        ...
                        {os.locationAddress && (
                          <span className="block text-xs text-slate-400 mt-0.5">{os.locationAddress}</span>
                        )}
                      </td>
