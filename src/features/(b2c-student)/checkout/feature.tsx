...
export default function CheckoutFeature() {
  ...
  const handlePay = () => {
    ...
    setTimeout(() => {
      ...
      router.push(
        `/experiments/b2c-student/checkout/success?order=${orderNumber}&total=${total}&count=${cartItems.length}`
      );
    }, 1400);
  };
    ...
    <div className="bg-zinc-950 text-white min-h-screen">
      ...
      <div className="max-w-screen-xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-1.5 text-xs text-zinc-500 mb-6">
          ...
          <Link href="/experiments/b2c-student/cart" className="hover:text-zinc-300 transition-colors">장바구니</Link>
          <ChevronRight className="w-3 h-3" />
