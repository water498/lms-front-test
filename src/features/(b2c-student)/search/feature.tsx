...
import { allCourses, type Course } from "../home/mockData";
import { TYPE_BADGE } from "../home/components/course-card";
    ...
    <nav className="sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800/50">
      <div className="max-w-screen-xl mx-auto px-6 h-16 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link href="/experiments/b2c-student/cart" className="relative p-2 text-zinc-400 hover:text-white rounded-lg hover:bg-zinc-800 transition-colors">
          ...
          <Link href="/experiments/b2c-student/my" className="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-lg hover:bg-zinc-800 transition-colors">
      ...
      <div className="shrink-0 flex flex-col items-end justify-between gap-2 min-w-[100px]">
        ...
        <div className="flex flex-col items-end gap-1.5">
          ...
          {(course.price ?? 0) > 0 ? (
            ...
            <Link
              href={`/experiments/b2c-student/courses/${course.id}`}
...
export default function SearchFeature() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    setQuery(inputValue);
    router.replace(`/experiments/b2c-student/search?q=${encodeURIComponent(inputValue)}`);
  };
              ...
              <div className="flex flex-col items-center justify-center py-24 gap-4">
                ...
                {(query || hasFilters) && (
                  <div className="flex gap-2">
                    {query && (
                      <button
                        onClick={() => { setQuery(""); setInputValue(""); router.replace("/experiments/b2c-student/search"); }}
