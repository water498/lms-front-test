...
import { Bell, User, Search, BookOpen, Award, Heart, Settings } from "lucide-react";
    ...
    <nav className="sticky top-0 z-50 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800/50">
      <div className="max-w-screen-xl mx-auto px-6 h-16 flex items-center gap-8">
        <Link href="/experiments/b2b-student" className="text-xl font-bold text-white shrink-0">
          ...
          <span className="text-sm font-normal text-zinc-400 ml-2">| ACME Corp</span>
        </Link>
        ...
        <aside className="w-full lg:w-64 shrink-0">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 flex flex-col items-center gap-3 mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-zinc-500">개발팀 · 시니어 엔지니어</p>
              <p className="text-xs text-zinc-600 mt-0.5">hong@acme.com</p>
            </div>
            <div className="w-full grid grid-cols-3 gap-2 text-center border-t border-zinc-800 pt-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-zinc-500">관심</p>
              </div>
            </div>
          </div>
