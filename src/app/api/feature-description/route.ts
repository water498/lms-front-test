...
const URL_TO_FEATURE: { role: string; urlSegments: string[]; featurePath: string }[] = [
  ...
  { role: "student", urlSegments: ["wishlist"], featurePath: "course-wishlist" },
  { role: "student", urlSegments: ["cart"], featurePath: "shopping-cart" },
  { role: "student", urlSegments: ["checkout"], featurePath: "payment-checkout" },
  { role: "student", urlSegments: ["ai-chat"], featurePath: "ai-learning-chat" },
  { role: "student", urlSegments: ["announcements"], featurePath: "student-announcement-list" },
  { role: "student", urlSegments: ["terms"], featurePath: "legal-terms" },
  { role: "student", urlSegments: ["my"], featurePath: "my-page-layout" },
  // ── Instructor ──
  { role: "instructor", urlSegments: ["sessions"], featurePath: "instructor-session-list" },
  { role: "instructor", urlSegments: ["sessions", "*"], featurePath: "session-layout" },
  { role: "instructor", urlSegments: ["reviews"], featurePath: "instructor-review-list" },
  { role: "instructor", urlSegments: ["payouts"], featurePath: "instructor-payout-list" },
  { role: "instructor", urlSegments: ["bank"], featurePath: "instructor-bank-account" },
  { role: "instructor", urlSegments: ["profile"], featurePath: "instructor-profile" },
